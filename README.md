...
## ParaMiner : Parameter miner for humans
...
$ git clone https://github.com/chapo58/ParaMiner
$ cd ParaMiner
...
### ParaMiner + GF (for massive pwnage)

  

Lets say you have already installed ParaMiner and now you want to filter out the juicy parameters from plethora of parameters. No worries you can easily do it using [GF(by tomnomnom)](https://github.com/tomnomnom/gf) .
...
Note : Paste JSON files(https://github.com/chapo58/ParaMiner/tree/master/gf_profiles) in ~/.gf/ folder

Now run ParaMiner and navigate to the output directory
